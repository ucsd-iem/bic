...
class AbstractsControllerTest < ActionController::TestCase
  ...
  test "should create abstract" do
    assert_difference('Abstract.count') do
      post :create, abstract: { affiliations: @abstract.affiliations, authors: @abstract.authors, body: @abstract.body, email: @abstract.email, keywords: @abstract.keywords, title: @abstract.title }
    end
  ...
  test "should update abstract" do
    put :update, id: @abstract, abstract: { affiliations: @abstract.affiliations, authors: @abstract.authors, body: @abstract.body, email: @abstract.email, keywords: @abstract.keywords, title: @abstract.title }
    assert_redirected_to abstract_path(assigns(:abstract))
  end
