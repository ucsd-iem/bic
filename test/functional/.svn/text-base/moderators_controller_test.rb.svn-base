...
class ModeratorsControllerTest < ActionController::TestCase
  ...
  test "should create moderator" do
    assert_difference('Moderator.count') do
      post :create, moderator: { affiliaiton: @moderator.affiliaiton, first_name: @moderator.first_name, last_name: @moderator.last_name, middle_name: @moderator.middle_name }
    end
  ...
  test "should update moderator" do
    put :update, id: @moderator, moderator: { affiliaiton: @moderator.affiliaiton, first_name: @moderator.first_name, last_name: @moderator.last_name, middle_name: @moderator.middle_name }
    assert_redirected_to moderator_path(assigns(:moderator))
  end
